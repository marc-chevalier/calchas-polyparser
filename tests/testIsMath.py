from calchas_polyparser.isMath import is_math
...
class TestSympy(TestCase):
    ...
    def testIsMath(self):
        mathematical_expressions = ['sin[x]',
                                    'sin(x)',
                                    'Arctan[x]',
                                    'atan(x)',
                                    'x**2',
        ...
        natural_language_sentences = ['What is the birth date of the president of the United States?',
